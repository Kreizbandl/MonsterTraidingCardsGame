...
public abstract class Handler {
    ...
    public static enum StatusCode {
        CREATED(201), NOCONTENT(204) ,OK(200), BADREQUEST(400), UNAUTHORIZED(401), FORBIDDEN(403);
    ...
    protected void sendResponseHeader(HttpExchange exchange, int code, long responseLength) throws IOException {
        exchange.getResponseHeaders().set("Content-Type", "application/json");
        exchange.sendResponseHeaders(code, responseLength);
    }

    protected void sendResponseBody(HttpExchange exchange, byte[] response) throws IOException {
